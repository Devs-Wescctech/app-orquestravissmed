...
import { BookingAlerts, type SkippedAlertDoctor } from '@/components/bookings/BookingAlerts';
import { SyncExecutionSummary } from '@/components/sync/SyncExecutionSummary';
import { useState, useEffect } from 'react';
import { CheckCircle2, Hourglass, AlertTriangle, Settings2, Users, Loader2, UserSquare2, CalendarDays, ExternalLink, Activity, ArrowUpRight, Clock } from 'lucide-react';
...
export default function DashboardOverview() {
    ...
    return (
        <div className="max-w-7xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <BookingAlerts skippedAlerts={skippedAlerts} dismissingAlerts={dismissingAlerts} handleDismissAlerts={handleDismissAlerts} />
