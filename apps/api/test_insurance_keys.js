...
async function testUpdate() {
    try {
        ...
        const addr = addrs._items[0];
        console.log("Keys:", Object.keys(addr));
        console.log("has insuranceSupport:", 'insuranceSupport' in addr, 'value:', addr.insuranceSupport);
        console.log("has insurance_support:", 'insurance_support' in addr, 'value:', addr.insurance_support);
    } catch (e) {
        console.error(e);
    }
}
