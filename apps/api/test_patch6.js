...
async function testUpdate() {
    try {
        ...
        const headers = { 'Authorization': `Bearer ${access_token}`, 'Content-Type': 'application/json-patch+json', 'Accept': 'application/json' };
        ...
        await tryPatch([
            { op: 'replace', path: '/name', value: 'Test Name JSON PATCH' }
        ]);
